...
export default function App() {
  ...
  return <div className="site-shell">
    ...
    <div className={`mobile-menu ${menuOpen?'open':''}`} aria-hidden={!menuOpen}><div className="mobile-menu-inner">{NAV_LINKS.map(([id,label],index)=><button key={id} onClick={()=>goTo(id)}><span>0{index+1}</span>{label}</button>)}<a href="mailto:riishabb@gmail.com">riishabb@gmail.com <Icon name="arrow"/></a></div></div>
      ...
      <section id="home" className="hero">
        ...
        <div className="hero-content">
          <div className="hero-copy">
            ...
            <div className="hero-actions"><button className="button primary" onClick={()=>goTo('experience')}>Explore my experience <Icon name="arrow"/></button><a className="button secondary" href="mailto:riishabb@gmail.com">Start a conversation</a></div>
